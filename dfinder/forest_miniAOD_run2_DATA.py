...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string("HiForestMiniAOD_Inclusive_OnlyCharged_DATA_numEvents"+str(numEvents)+".root"))
    #fileName = cms.string("HiForestMiniAOD_FullParticles_DATA_numEvents"+str(numEvents)+".root"))

    # per task di crab
    #fileName = cms.string("HiForestMiniAOD_OnlyCharged_DATA.root"))
    #fileName = cms.string("HiForestMiniAOD_FullParticles_DATA.root"))
